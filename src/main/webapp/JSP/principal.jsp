...
<html>
    ...
    <body>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavId">
                        <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                            <li class="nav-item">
                                <input type="submit" class="nav-link active text-white" value="Inicio" name="option" aria-current="page"/>
                            </li>
                            <li class="nav-item">
                                <input type="submit" class="nav-link text-white" value="Tienda" name="option"/>
                            </li>
                            <li class="nav-item">
        ...
        <div class="container">
            <h2 class="text-white mt-3">Top Ventas</h2>
