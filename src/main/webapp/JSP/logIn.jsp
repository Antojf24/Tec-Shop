                ...
                <div class="row justify-content-end">
                    <div class="col-6">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <input type="text" name="password" id="pasword" class="form-control">
                                        <label for="repPassword" class="form-label mt-3">Repetir contraseña:</label>
                                        <input type="text" name="repPassword" id="repPassword" class="form-control">
                        ...
                        <div class="d-flex justify-content-end">
                            <input type="submit" name="crear" class="btn btn-primary mt-3" value="Crear cuenta">
                        </div>
                    </div>
                </div>
            </div>
